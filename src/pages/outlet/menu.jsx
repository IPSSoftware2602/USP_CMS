        ...
        <div className="bg-white border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className={`p-4 border flex items-center justify-center space-x-2 ${action === 'activate'
            ...
            <button
              ...
              className={`p-4 border flex items-center justify-center space-x-2 ${action === 'delete'
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 max-h-96 overflow-y-auto p-1">
                {outlets.map(outlet => (
                  <div
                    ...
                    className={`p-2 border cursor-pointer transition-colors ${selectedOutlets.includes(outlet.id)
                        ...
                        <p className="text-xs font-medium text-gray-900 truncate">
                          {
                            (outlet.title || outlet.name || '')
                              .replace(/uspizza|US Pizza|US PIZZA/gi, '')
                              .replace(/-/g, '')
                              .trim()
                          }
                        </p>
        ...
        <div className="bg-white border rounded-lg p-6">
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-white ${submitting || selectedOutlets.length === 0 || selectedMenuItems.length === 0
