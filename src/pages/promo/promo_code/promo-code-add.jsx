...
export default function AddPromoCode() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const response = await promoCodeService.create(apiData);
      ...
      if (response.status == 200) {
        ...
        toast.error(
          response.message || "Failed to create promo code. Please try again."
        );
      }
    } catch (error) {
      console.error("Error creating promo code:", error);
      toast.error(
        error.message || "Failed to create promo code. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const navigateToPromoSettings = () => {
    navigate("/promo/settings");
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={navigateToPromoSettings}
