...
const OrderPending = () => {
  ...
  const loadOrders = async (filters = {}, page = 1, perPage = 1000) => {
    ...
    try {
      ...
      // ✅ Store both data and filteredData
      setData(transformed);
  ...
  const handleViewDetails = (row) => {
    navigate(`/orders/order_pending/order_overview/${row.id}`);
  };
    ...
    <>
      ...
      <div className="w-full bg-white shadow-lg rounded-lg">
        <div className="flex justify-between items-center p-6 bg-white rounded-lg">
          <h1 className="text-2xl font-semibold text-gray-900">Pending List</h1>
